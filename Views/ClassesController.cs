...
namespace GRP7_GestionEcole.Views
{
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDClasse,NomClasse,NomCours,NombreEtudiant")] Classe classe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDClasse,NomClasse,NomCours,NombreEtudiant")] Classe classe)
        {
