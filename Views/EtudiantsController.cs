...
namespace GRP7_GestionEcole.Views
{
    public class EtudiantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDEtudiant,NomEtudiant,PrenomEtudiant,Age,EmailEtudiant")] Etudiant etudiant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDEtudiant,NomEtudiant,PrenomEtudiant,Age,EmailEtudiant")] Etudiant etudiant)
        {
